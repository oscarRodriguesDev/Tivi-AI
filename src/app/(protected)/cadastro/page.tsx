...
export default function CadastroPage() {
  ...
  return (
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-900 px-4">
      <div className="bg-gray-800 p-10 rounded-2xl shadow-xl w-full max-w-2xl">
      
        <h1 className="text-3xl font-semibold text-center text-white mb-6">Cadastro</h1>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-white transition"
              value={name}
