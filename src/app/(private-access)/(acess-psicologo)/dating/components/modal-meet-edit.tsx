      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
        <div className="relative bg-white rounded-lg w-full max-w-[787px] h-full max-h-[90vh] p-6 overflow-y-auto">
          ...
          <div className="flex items-center justify-start gap-3 mb-5">
            <FaCalendar size={40} />
            <h2 className="font-bold text-2xl text-black">Editar Agendamento</h2>
          </div>
          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            <div className="space-y-4">
              ...
              {/* Apelido */}
              <div className="flex-col gap-4">
                <label className="block text-sm font-medium text-gray-800">Identificador unico</label>
                <div className="flex items-center gap-3">
              ...
              {/* Observações */}
              <div className="flex-col gap-4">
                <label className="block text-sm font-medium text-gray-800">Sintomas</label>
                <div className="flex items-center gap-3">
