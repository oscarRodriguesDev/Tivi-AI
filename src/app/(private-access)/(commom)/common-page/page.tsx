      ...
      {role === "PSYCHOLOGIST" || role === "ADMIN" ? (
        <div className="px-4 py-6 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow text-gray-800">
            <h2 className="text-2xl font-semibold mb-2">Olá, {session.data?.user.name ?? "Profissional"} 👋</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 border border-blue-200 p-4 rounded-2xl flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-bold">{dadosMock.consultasHoje}</p>
              </div>
            </div>
            <div className="bg-green-50 border border-green-200 p-4 rounded-2xl flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-bold">{dadosMock.pacientesAtivos}</p>
              </div>
            </div>
            <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-2xl flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-bold">{dadosMock.mensagensNaoLidas}</p>
              </div>
            </div>
          </div>

          {/* Dica do dia */}
          <div className="bg-white p-5 rounded-2xl shadow flex items-start gap-4">
            <FaLightbulb className="text-yellow-500 text-3xl mt-1" />
            <div>
              <h3 className="font-semibold text-gray-800 mb-1">Dica do Dia</h3>
              <p className="text-gray-700">{dadosMock.dicaDoDia}</p>
            </div>
          </div>

          {/* Código de ética / lembrete */}
          <div className="bg-gray-100 border-l-4 border-gray-400 p-4 rounded-xl text-sm text-gray-700">
        ...
        <div className="flex justify-center items-center h-screen text-gray-600 text-center px-4">
