...
const PoliticaCookies = () => {
    ...
    const handleDownload = () => {
        ...
        element.download = "politica-de-cookies-tiviai.txt";
    ...
    return (
        ...
        <div className="max-w-4xl mx-auto px-6 py-10 text-justify bg-white text-black rounded-2xl shadow-md" id="politica-cookies">
            ...
            <p className="leading-relaxed mb-4">
                A TiviAi valoriza a privacidade e a transparência no tratamento dos dados de seus usuários. Esta Política de Cookies tem como
            ...
            <p className="leading-relaxed mb-4">
                Os cookies desempenham um papel fundamental no funcionamento da plataforma da TiviAi. Abaixo listamos os principais motivos pelos quais
                os utilizamos:
            </p>
            ...
            <p className="mb-4">
                <strong className="text-[#3D975B]">Importante:</strong> a TiviAi não utiliza cookies com fins publicitários ou para rastrear comportamento fora de nossa plataforma.
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-3 text-[#3D975B]">4. Quais cookies utilizamos</h2>
            <p className="leading-relaxed mb-4">
                Os cookies utilizados pela TiviAi podem ser classificados conforme a sua finalidade e tempo de expiração:
            </p>
            <ul className="list-disc list-inside mb-4 pl-4">
            ...
            <p className="mb-4">
                Lembre-se de que desabilitar todos os cookies pode impactar negativamente sua experiência de navegação na TiviAi.
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-3 text-[#3D975B]">7. Compartilhamento com terceiros</h2>
            <p className="leading-relaxed mb-4">
                Atualmente, a TiviAi não compartilha dados de cookies com terceiros, nem utiliza serviços externos de rastreamento como
            ...
            <p className="leading-relaxed mb-4">
                A TiviAi reserva-se o direito de modificar esta Política de Cookies sempre que necessário. As alterações entram em vigor
            ...
            <p className="leading-relaxed mb-6">
                ...
                <br />E-mail: <a href="mailto:admin@tiviai.com.br" className="text-[#3D975B]">admin@tiviai.com.br</a>
